...
contract Prova is Context, IBEP20, Ownable {
    ...
    address payable private _marketingWallet = payable(0x7bf44672FC94f4C089f37025e6B97d3305F17B02);
    address payable private _devWallet = payable(0xfA394e4390DA412d7Fba300328a05d419e0E95e2);
    ...
    uint256 public maxMarketingFee = 20;
    ...
    uint256 public maxLiquidityFee = 5;
    ...
    constructor () {
        ...
        // real router
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x482eC5Bac2e048014187D245b2C8aaa49A6284a8);
