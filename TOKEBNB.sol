...
contract TokenContract is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    bool public isMaxSellLimitValid = true; // max selling Limit is valid if it's true
    ...
    uint256 private _currentAwardFee;
    uint256 private _currentConservationFee;
